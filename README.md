...
This repository contains template web services and user interfaces for the Neosofia platform. 
Use these Copier templates to quickly scaffold new repositories with firm-wide standards, architectures, and conventions pre-wired out of the box.
